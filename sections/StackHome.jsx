...
const StackHome = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-col justify-start items-start pl-10 py-5 text-white space-y-2 bg-black h-screen">
        <div className="text-white space-y-2 w-[270px]">
          ...
          <div>
            <p className="text-[49px] font-extrabold w-12 leading-10">
              Meta Lives
            </p>
          </div>
          <div>
        ...
        <div className="">
          <div className="box-content py-2 px-5 w-fit text-[18px] text-black bg-[#FFCA5F] rounded-full font-bold font-sans">
            Join Waitlist
          </div>
        </div>
      </div>
